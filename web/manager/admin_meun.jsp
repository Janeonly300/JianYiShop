    ...
    <div class="topbar-inner clearfix">
        <div class="topbar-logo-wrap clearfix">
            ...
            <ul class="navbar-list clearfix">
                ...
                <li><a href="/JianYiShop/index.jsp" target="_blank">网站首页</a></li>
            </ul>
        </div>
        ...
        <div class="sidebar-content">
            <ul class="sidebar-list">
                <li>
                    ...
                    <ul class="sub-menu">
                        <li><a href="/JianYiShop/manager/douserservelt"><i class="icon-font">&#xe008;</i>用户管理</a></li>
                        ...
                        <li><a href="admin_msg.jsp"><i class="icon-font">&#xe012;</i>留言管理</a></li>
